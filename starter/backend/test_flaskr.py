...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_categories(self):
        ...
        self.assertEqual(data['total_categories'], len(data['categories'].keys()))
    ...
    def test_delete_specific_question(self):
        ...
        self.assertEqual(data['total_questions'], total_questions_before_deleting-1)
    ...
    def test_search_question(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertTrue(data['questions'])
        self.assertEqual(len(data['questions']), len(Question.query.order_by(Question.id).filter(Question.question.ilike('%{}%'.format('title'))).all()))
